...
def spawn_engine() -> bool:
    ...
    Returns True if the engine was spawned and became healthy within the timeout.
    """
    ...
    logger.info(f"Engine process spawned (pid={proc.pid}), waiting for health...")
    ...
    while time.time() < deadline:
        ...
        if proc.poll() is not None:
            ...
            # Our spawn failed — but maybe another client won the race
            ...
            # and a healthy engine is now available
            ...
            if info:
                ...
                if port and pid and _check_engine_health(port):
                    ...
                    logger.info(
                        ...
                        f"Our spawn exited (code {proc.returncode}) but another "
                        ...
                        f"engine is healthy (pid={pid}, port={port})"
            ...
            logger.error(
                ...
                f"Engine process exited with code {proc.returncode} "
                ...
                f"and no other engine is available"
        ...
        if info:
            ...
            if port and pid and _check_engine_health(port):
                ...
                logger.info(f"Engine process is healthy (pid={pid}, port={port})")
    ...
    logger.error(
        ...
        f"Engine process did not become healthy within {_ENGINE_STARTUP_TIMEOUT}s"
    ...
    # Last-ditch: maybe another process's engine is now healthy
    ...
    if info:
        ...
        if port and pid and _check_engine_health(port):
            ...
            logger.info(f"Another engine became healthy during our wait (pid={pid})")
